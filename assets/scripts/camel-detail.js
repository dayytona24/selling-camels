  ...
  detailShell.innerHTML = `
    ...
    <article class="detail-copy">
      ...
      <div class="contact-card detail-contact">
        ...
        <p>Speak directly with HQ Ranch for pricing, temperament, and transport questions.</p>
        <div class="contact-lines">
          <span>Hqranchcamels@gmail.com</span>
          <span>+1 (918) 706-3161</span>
        </div>
        <div class="contact-buttons">
          <a class="btn btn-primary" href="https://mail.google.com/mail/?view=cm&fs=1&to=Hqranchcamels@gmail.com" target="_blank" rel="noopener">Email Ranch</a>
